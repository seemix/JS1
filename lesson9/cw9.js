...
for (const simpson of simpsons) {
    ...
    div.innerHTML = `Name: ${simpson.name}, <br>Surname: ${simpson.surname}, <br>Age: ${simpson.age}, <br>Info: ${simpson.info}, <br>Photo: ${simpson.photo}<br><br>`;
...
coursesArray.forEach(item => {
    ...
    item.modules.forEach(mod => {
        ...
        module.innerText = mod;
        modules.appendChild(module);
    })
    itemDiv.append(divTitle, duration, modules);
